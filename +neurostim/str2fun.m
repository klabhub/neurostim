...
% Convert a string conforming to the Neurostim function format into a Matlab function handle
% str - the string
% OUTPUT
% f = function handle for internal use by cic/plugins
%
% 
% BK - Mar 2016
...
elseif ~isempty(str) && strcmpi(str(1),'@')
    ...
    % Replaceit with setProperty(a,b);       

...
%     KbStrokeWait(-1);
    ...
    [win3, winRect3] = PsychImaging('OpenWindow', screenId, background, [0 330 1400 630], [], [], [], [], [], kPsychGUIWindow);
    ...
    lCntr =0;
rects = ArrangeRects(10,[0 0 20 20],winRect3);
for l = 1:10
        xyY = [1/3 1/3 l*2]';
     
    Screen('FillRect', win3, xyY, rects(l,:));
